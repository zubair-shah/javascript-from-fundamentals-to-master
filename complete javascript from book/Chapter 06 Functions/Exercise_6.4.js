...
// Modify the calculator that you made in Practice exercise 6.2 to return
// added values instead of printing them. Then, call the function 10 or more
// times in a loop, and store the results in an array. Once the loop finishes,
// output the final array into the console.
...
// into the function when it is called. Add the values together, returning
// the result.
// 4. Within the loop, call the calculation function, passing in the two values
// as arguments into the function and storing the returned result in a
// response variable.
...
// console.
// 7. You should see the values [0, 6, 14, 24, 36, 50, 66, 84, 104,
// 126] for the array in the console
